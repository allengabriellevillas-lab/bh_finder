        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input type="text" name="location" class="form-control <?= isset($errors['location'])?'error':'' ?>"
                   placeholder="e.g. 123 Osme&ntilde;a Blvd" value="<?= sanitize($formData['location']) ?>" required>
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <div class="file-upload">
          ...
          <p class="file-upload-text" style="font-size:.8rem;margin-top:4px">JPEG, PNG, WebP &middot; Max 5MB per image &middot; First image becomes the cover</p>
        </div>
