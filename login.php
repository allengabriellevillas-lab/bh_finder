...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email) || empty($password)) {
        ...
        if ($user && password_verify($password, $user['password'])) {
            ...
            $redirect = $_GET['redirect'] ?? ($user['role']==='owner' ? SITE_URL.'/pages/owner/dashboard.php' : SITE_URL.'/index.php');
...
<div class="auth-wrap">
  <div class="auth-card">
    ...
    <div style="text-align:center;font-size:.875rem;color:var(--text-muted)">
      ...
      Owner: <code>owner@demo.com</code> | Tenant: <code>tenant@demo.com</code><br>
